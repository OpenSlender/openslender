...
namespace OpenSlender
{
	...
	public partial class PlayerSettings : Resource
	{
		...
		[Export] public float IdleStopDampingMultiplier { get; set; } = 3.0f;
		[Export] public float CrouchStopDampingMultiplier { get; set; } = 3.0f;
		[Export] public float LandingStopDampingMultiplier { get; set; } = 2.0f;
